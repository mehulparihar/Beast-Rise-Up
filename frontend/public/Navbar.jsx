...
import { Search, User, Heart, ShoppingCart, X, Menu, ChevronDown, Truck, Shield } from "lucide-react"
...
const Navbar = () => {
  ...
  // Helper: navigate and close mobile menu
  const goTo = (path) => {
    navigate(path)
    setMobileOpen(false)
    setSearchOpen(false)
    ...
    <>
      <header
        className={`sticky top-0 z-50 w-full transition-all duration-500 ${
          isScrolled ? "bg-white/95 backdrop-blur-xl shadow-lg shadow-gray-200/50" : "bg-white"
        }`}
      >
        {/* ── Top Nav Bar ── */}
            ...
            <div className="flex items-center justify-between h-16">
              ...
              <div className="flex items-center gap-1">
                ...
                <motion.button
                  ...
                  whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                  className="relative p-2.5 rounded-lg hover:bg-gray-100 text-gray-700 transition-colors hidden sm:flex"
                >
                  <Heart size={20} />
              ...
              <div className="flex items-center gap-1">
                {navLinks.map((link) => (
                  <motion.a
                    ...
                    className="relative px-4 py-2 text-sm font-semibold text-gray-700 hover:text-red-600 transition-colors rounded-md hover:bg-white"
                  >
                    {link.label}
                  </motion.a>
                ))}
          ...
          {mobileOpen && (
            ...
            >
              <div className="max-h-[80vh] overflow-y-auto">
                ...
                {/* ✅ Account Actions — mirrors desktop buttons with correct navigation */}
                <div className="p-4 border-t border-gray-100 space-y-3">
                  ...
                  <motion.button
                    ...
                    className="w-full flex items-center gap-3 px-4 py-3.5 bg-white border border-gray-200 text-gray-800 font-semibold rounded-xl hover:border-gray-300 hover:bg-gray-50 transition-colors"
                  >
                  ...
                  {/* Cart — with live total + count badge */}
                  <motion.button
                    whileTap={{ scale: 0.98 }}
                    onClick={() => goTo("/checkout")}
                    className="w-full flex items-center justify-between px-4 py-3.5 bg-gray-900 text-white font-semibold rounded-xl hover:bg-gray-800 transition-colors"
                  >
                ...
                {/* Trust Badges */}
                <div className="px-4 pb-4 flex items-center justify-center gap-6 text-xs text-gray-500">
